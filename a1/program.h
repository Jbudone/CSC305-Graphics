...
public:
     ...
     */
    std::map<std::string, AbstractParameter *>::iterator getParameterBegin()
    {
     ...
     *	@return	returns the iterator
     */
    std::map<std::string, AbstractParameter *>::iterator getParameterEnd()
    {
     ...
     */
    AbstractParameter * getParameter(std::string m_Name)
    {
     ...
     *	@return	returns the iterator
     */
    std::map<std::string, AbstractParameter *>::iterator getAttributeBegin()
    {
     ...
     *	@return	returns the iterator
     */
    std::map<std::string, AbstractParameter *>::iterator getAttributesEnd()
    {
     ...
     *	@return	returns the pointer to the parameter
     */
    AbstractParameter * getAttribute(std::string m_Name)
    {
...
protected:
    ...
    std::map<std::string, AbstractParameter *>	mParameters;		/**< the parameters in the program. */
    std::map<std::string, AbstractParameter *>	mAttributes;		/**< the attributes in the program. */
